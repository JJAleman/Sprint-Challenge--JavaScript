...
const largerPopulation = zooAnimals.filter( getPopulation => getPopulation.population < 5);
...
const populationTotal = zooAnimals.reduce((total, popSum) => total + popSum.population, 0);
